...
class McpSettingsConfigurable : Configurable {
    ...
    override fun getDisplayName(): String = "Producer MCP"
    ...
    override fun createComponent(): JComponent {
        ...
        myPanel = panel {
            ...
            group("Links") {
                ...
                row {
                    browserLink("Documentation", "https://platform.acedata.cloud/documents/producer")
                }
                row {
                    browserLink("Source Code", "https://github.com/AceDataCloud/ProducerMCP")
                }
                row {
                    browserLink("PyPI Package", "https://pypi.org/project/mcp-producer/")
                }
            }
        }
